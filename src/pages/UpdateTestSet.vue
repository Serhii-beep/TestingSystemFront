<template>
    <div class="testbox">
        <div class="form">
            ...
            <div class="btn-block">
                <button @click="updateTestSet">Update<i class="fa-solid fa-pen-to-square add"></i></button>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        updateTestSet() {
            ...
            axios.put(`https://localhost:44310/api/TestSets/put/${this.testSetId}`, {
                id: this.testSetId,
            ...
            }).then(() => this.$router.push({path: '/allTests'}))
                .catch(err => {
                    this.color = "red";
    ...
    mounted() {
        ...
        axios.get(`https://localhost:44310/api/TestSets/getById/${this.testSetId}`)
            .then(response => {
                this.selectedCategory = response.data.entity.testCategoryId;
                this.selectedLevel = response.data.entity.testLevelId;
                this.description = response.data.entity.description; 
        });
    }
}
</script>
